...
const HotelCard = ({ room, index }) => {
  return (
    <Link
      ...
      className="relative block max-w-sm w-full rounded-xl overflow-hidden bg-white text-gray-500/90 shadow-[0px_4px_4px_rgba(0,0,0,0.5)]"
    >
      <img src={room.images[0]} alt={room.hotel.name} className="" />
